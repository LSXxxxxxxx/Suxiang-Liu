...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑图书类型</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑图书类型</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					...
					<input name="tushuleixing" id="tushuleixing" name="tushuleixing" class="form-control" placeholder="请输入图书类型">
				</div>
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.tushuleixing != null && res.data.tushuleixing != ''){
						...
						$("#tushuleixing").attr('readonly','readonly');
					}
				}
			});
            }
