...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑修改Password</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>修改Password管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑修改Password</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>原Password</label>
					<input id="oldPassword" name="oldPassword" type="password" class="form-control" placeholder="原Password">
				</div>
				<div class="form-item">
					<label>新Password</label>
					<input id="newPassword" name="newPassword" type="password" class="form-control" placeholder="新Password">
				</div>
				<div class="form-item">
					<label>确认Password</label>
					<input id="confirmPassword" type="password" name="confirmPassword" class="form-control" placeholder="确认Password">
				</div>
				<div class="form-btn">
	...
	<%@ include file="../../static/md5.js"%>
		...
		function validform() {
			return $("#addOrUpdateForm").validate({
				...
				messages : {
					oldPassword : {
						required : "原Password不能为空",
					},
					newPassword : {
						required : "新Password不能为空",
					},
					confirmPassword : {
						required : "确认Password不能为空",
						equalTo: "两次Password输入不一致",
					},
				}
			}).form();
		}
