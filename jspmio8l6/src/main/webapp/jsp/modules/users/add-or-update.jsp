...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑管理员</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑管理员</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>用户名</label>
					<input name="username" id="username" name="username" class="form-control" placeholder="请输入用户名">
				</div>
				<div class="form-item">
					<label>Password</label>
					<input name="password" id="password" name="password" class="form-control" placeholder="请输入Password">
				</div>
