...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑图书归还</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑图书归还</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>借阅时间</label>
					<input name="jieyueshijian" id="jieyueshijian" name="jieyueshijian" class="form-control" placeholder="请输入借阅时间">
				</div>
				<div class="form-item">
					<label>归还时间</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#jieyueshijian").val(ruleForm.jieyueshijian);
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.jieyueshijian != null && res.data.jieyueshijian != ''){
						...
						$("#jieyueshijian").val(res.data.jieyueshijian);
						$("#jieyueshijian").attr('readonly','readonly');
					}
