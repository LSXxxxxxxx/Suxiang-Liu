...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑图书借阅</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑图书借阅</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>借阅编号</label>
					<input id="jieyuebianhao" name="jieyuebianhao" class="form-control" value="" readonly>
				</div>
				<div class="form-item">
				...
				<div class="form-item">
					<label>超期费用</label>
					<input name="chaoqifeiyong" id="chaoqifeiyong" name="chaoqifeiyong" class="form-control" placeholder="请输入超期费用">
				</div>
				<div class="form-item">
					<label>借阅时间</label>
				...
				<div class="form-item">
					...
					<select id="jieyuezhuangtaiSelect" name="jieyuezhuangtai" class="form-control">
							...
							<option class="jieyuezhuangtaiOption" value="未归还">
								未归还
							</option>
					</select>
				</div>
	...
	<script>
		...
		function jieyuebianhaoUuid(){
			if($("#jieyuebianhao").val() == null || $("#jieyuebianhao").val() == "null" || $("#jieyuebianhao").val() == ""){
				$("#jieyuebianhao").attr("value",Math.round(new Date().getTime()/1000));
			}
		}
		...
		function submit() {
                //获取表单数据前取消禁用
                $("#jieyuezhuangtaiSelect").attr('disabled',false);
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				...
				for(var jieyuezhuangtaiCount = 0; jieyuezhuangtaiCount < jieyuezhuangtaiOptions.length;jieyuezhuangtaiCount++){
					if(jieyuezhuangtaiOptions[jieyuezhuangtaiCount].getAttribute('value') == "未归还"){
		...
		function readonly(){
            if(window.sessionStorage.getItem('role')!="管理员") {
                ...
                $("#jieyuezhuangtaiSelect").attr('disabled',true);
            }
		}
