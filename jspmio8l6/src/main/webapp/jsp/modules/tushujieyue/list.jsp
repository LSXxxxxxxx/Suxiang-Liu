...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">图书借阅管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>图书借阅管理</span></li>
				<li class="breadcrumb-item-two"><span>图书借阅列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>借阅编号</label>
					<input type="text" id="jieyuebianhaoSearch" class="form-control form-control-sm" placeholder="请输入借阅编号" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>图书名称</label>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('chaoqifeiyong')">超期费用<i id="chaoqifeiyongIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#jieyuebianhaoSearch').val() != null && $('#jieyuebianhaoSearch').val() != ''){
				searchForm.jieyuebianhao ="%" +  $('#jieyuebianhaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("tushujieyue/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				jieyuebianhao : searchForm.jieyuebianhao,
		...
		function setDataRow(item,number){
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "图书归还"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'tushuguihai','是','jieyuezhuangtai','已归还','已归还,未归还'.split(',')[0])");
			if(crossBtnControl('图书归还') == true){
				btnGroup.appendChild(crossBtn0);
			}
			var crossBtn1 = document.createElement('button');
            		crossBtn1.innerHTML = "违约记录"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'weiyuejilu','是','[1]','请勿重复操作')");
			if(crossBtnControl('违约记录') == true){
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"tushujieyue");
