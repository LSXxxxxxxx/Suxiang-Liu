...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">图书信息评论表管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>图书信息评论表管理</span></li>
				<li class="breadcrumb-item-two"><span>图书信息评论表列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var btnGroup = document.createElement('td');
                        ...
                        discussReplyBtn.setAttribute("class","btn btn-warning btn-sm Reply");
                        discussReplyBtn.setAttribute("onclick",discussReplyAttr);
                        discussReplyBtn.innerHTML = "Reply"
