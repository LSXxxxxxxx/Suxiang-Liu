	...
	<div id="apps">
		<div id="header" :style='{"padding":"0px","margin":"0 auto","alignItems":"center","display":"flex","right":"0","justifyContent":"space-between","overflow":"hidden","top":"0","left":"0","background":"#333","width":"100%","position":"relative","height":"44px","zIndex":"1002"}'>
			...
			<div :style='{"width":"180px","margin":"0","alignItems":"center","display":"flex"}'>
				...
				<button v-if="!Token" :style='{"border":"0px solid #ffc303","cursor":"pointer","padding":"0 20px","margin":"0 0 0 10px","color":"#fff","borderRadius":"0px","background":"#288bbf","display":"inline-block","fontSize":"14px","lineHeight":"30px","height":"30px"}' @click="jumpLogin('./pages/login/login.jsp')">Login/Register</button>
				<button v-if="Token" :style='{"border":"0px solid #fff","cursor":"pointer","padding":"0 20px","margin":"0 0 0 10px","color":"#666","borderRadius":"0px","background":"#fff","display":"inline-block","fontSize":"14px","lineHeight":"30px","height":"30px"}' @click="logout()">Logout</button>
			</div>
		</div>
		...
		<div id="navs" class="horizontal" :style='{"width":"100%","padding":"0","margin":"0px auto 0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230127/e1b074885e304a40bcfa7de91c22b700.png) no-repeat","height":"auto"}'>
			<ul class="layui-nav" lay-bar="disabled" :style='{"border":"0","padding":"0px","listStyle":"none","margin":"0","textAlign":"center","background":"none","width":"100%","lineHeight":"80px","position":"relative","zIndex":"11","height":"80px"}'>
				<li class='layui-nav-item current'><a href="javascript:navPage('./pages/home/home.jsp')" class="menumain"><i class="layui-icon layui-icon-home"></i><span>Home</span></a></li>
				...
				<li v-if="Token" class='layui-nav-item'><a href="javascript:centerPage();" class="menumain"><i class="layui-icon layui-icon-username"></i>Personal Center</a></li>
				<li v-if="Token" class='layui-nav-item'><a v-if="adminurl" :href="adminurl" target="_blank" class="menumain" style="cursor: pointer;"><i class="layui-icon layui-icon-link"></i><span>Backend Management</span></a></li>
			</ul>
		</div>
